...
{
    public partial class TransitionModifyForm : Form
    {
        public bool Succesful = false;
        public IVertexWrapper VertexWrapper { get; set; }
        public TransitionModifyForm(IVertexWrapper vertexWrapper)
        {
        ...
        private void VertexModifyForm_Load(object sender, EventArgs e)
        {
            ...
            angleUpDown.Value = Convert.ToDecimal(((VertexWrapper as TransitionWrapper).Angle % 360 + 360) % 360);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            (VertexWrapper as TransitionWrapper).Angle = Convert.ToDouble(angleUpDown.Value);
